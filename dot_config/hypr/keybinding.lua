...
bind = $mainMod, V, exec, clipvault list | awk -F '\t' '{print $1 "-" $2}' | tofi | cut -d '-' -f1 | clipvault get | wl-copy
bind = $mainMod, P, pseudo, # dwindle
bind = $mainMod, BackSpace, layoutmsg, swapsplit
bind = $mainMod, J, layoutmsg, togglesplit # dwindle
bind = $mainMod, L, exec, hyprctl keyword general:layout scrolling
